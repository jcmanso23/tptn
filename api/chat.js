...
export default async function handler(req, res) {
  ...
  const systemPrompt = [
    ...
    'Excepción cerrada de Portugal dos Pequenitos: solo si desafioActual contiene a la vez Batalha y Fátima, Paula y Hugo pueden descubrir ambos nombres al contrastar físicamente el parque. Explica que son dos señales mezcladas por Topoloco y que únicamente Batalha queda como destino accionable; no adelantes la misión de Batalha ni ninguna parada posterior.',
