...
El eclipse ya ha pasado. Antes del eclipse, Topotino entregó personalmente a Marga Mapas un paquete cerrado con una condición de emergencia. Marga debía hacérselo llegar a Paula y Hugo si, después del eclipse, Topotino no recordaba Luanco ni el motivo de la muestra. Marga no conoce la ruta y no explica el contenido.
...
[
  ...
  },
  {
    ...
    "messages": [
      ...
      { "from": "topotino", "time": "auto", "text": "Acaba de entrar una señal de Marga Mapas. No sé quién es, pero dice que antes del eclipse le entregué un paquete cerrado." },
      { "from": "topotino", "time": "auto", "text": "Le dejé una orden: si después del eclipse yo no recordaba Luanco, debía hacéroslo llegar a vosotros." },
      { "from": "topotino", "time": "auto", "text": "Dentro hay algo llamado «Mapa de las Doce Aguas». Vamos a abrirlo juntos." }
    ]
  },
  {
